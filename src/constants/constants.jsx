...
export const jsonPuntosVentas = [
  {
    ...
    direccion: 'Cra. 22 #8 -32, Centro, San José Del Guaviare, Guaviare',
    telefono: '+57 317 2647781',
    ruta :'https://maps.app.goo.gl/HUVcRq89ExMC6LLz8"'
  },
  {
    nombre: 'GRANADA',
    direccion: 'Calle 15 # 15 08 Centro',
    telefono: '+57 3104219462',
    ruta:'https://maps.app.goo.gl/6tAHiJUjntYzdx8s7'
  },
  {
    nombre: 'MELGAR',
    direccion: 'Cra. 22 #6 -24, Centro, Melgar, Tolima',
    telefono: '+57 3114084885',
    ruta:'https://maps.app.goo.gl/qmsMMwZ9kD3677WA8'
  },
  {
    nombre: 'FUSAGASUGA',
    direccion: 'CR 7 # 10 #42 Coburgo',
    telefono: '+57 3142190809',
    ruta:'https://maps.app.goo.gl/T2khHX58FNCm7hMF6'
  },
  {
    nombre: 'BOGOTA',
    direccion: 'Cl. 17 #102 - 42, Fontibón, Bogotá, Cundinamarca',
    telefono: '+57 3225149670',
    ruta:'https://maps.app.goo.gl/LA7dPCNZY5TuMcBU9'
  }
